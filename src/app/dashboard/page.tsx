    ...
    if (isLoading) {
        return (
            <div className="min-h-screen overflow-hidden relative flex flex-col items-center justify-center">
                ...
                <div className="absolute inset-0 bg-gradient-to-br from-blue-100 via-indigo-100 to-violet-100 dark:from-slate-950 dark:via-indigo-950 dark:to-purple-950 z-0"></div>

                {/* Animated pattern overlay */}
                <div className="absolute inset-0 bg-[radial-gradient(#4f46e512_1px,transparent_1px)] [background-size:32px_32px] opacity-70 dark:opacity-30 z-0"></div>

                {/* Enhanced gradient orbs with deeper colors and improved positioning */}
                <div className="absolute top-0 left-1/4 w-[40rem] h-[40rem] -translate-x-1/2 -translate-y-1/2 bg-gradient-to-br from-blue-500/30 to-blue-700/40 dark:from-blue-600/30 dark:to-blue-900/40 rounded-full mix-blend-multiply dark:mix-blend-soft-light filter blur-3xl opacity-70 dark:opacity-60 animate-blob"></div>
                <div className="absolute bottom-0 right-1/4 w-[45rem] h-[45rem] translate-x-1/3 translate-y-1/2 bg-gradient-to-tr from-purple-500/30 to-purple-700/40 dark:from-purple-600/30 dark:to-purple-900/40 rounded-full mix-blend-multiply dark:mix-blend-soft-light filter blur-3xl opacity-70 dark:opacity-60 animate-blob animation-delay-2000"></div>
                <div className="absolute bottom-1/2 left-1/2 w-[50rem] h-[50rem] -translate-x-1/2 translate-y-1/2 bg-gradient-to-tr from-indigo-500/30 to-indigo-700/40 dark:from-indigo-600/30 dark:to-indigo-900/40 rounded-full mix-blend-multiply dark:mix-blend-soft-light filter blur-3xl opacity-70 dark:opacity-60 animate-blob animation-delay-4000"></div>

                {/* Enhanced shimmering light beams with more contrast */}
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[100%] h-[50%] rotate-45 overflow-hidden opacity-30 dark:opacity-15 z-10">
                ...
                <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-1/2 h-1/3 bg-gradient-to-t from-blue-500/20 to-transparent dark:from-blue-600/30 dark:to-transparent blur-2xl"></div>
                <div className="absolute top-0 right-0 w-1/3 h-1/3 bg-gradient-to-bl from-purple-500/20 to-transparent dark:from-purple-600/30 dark:to-transparent blur-2xl"></div>
                ...
                <div className="relative z-20 flex flex-col items-center justify-center">
                    ...
                    <div className="relative mb-12 flex items-center justify-center">
                        <div className="relative h-20 w-20 rounded-full bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center shadow-xl">
                            ...
                            <div className="absolute -inset-4 border border-indigo-500/10 dark:border-indigo-400/10 rounded-full animate-spin-slow animation-delay-2000" style={{ animationDirection: 'reverse' }}></div>
                        </div>
                    ...
                    <div className="relative my-8 flex items-center justify-center">
                        ...
                        <svg className="h-16 w-16" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" aria-labelledby="loadingTitle">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <DropdownMenu>
                                <DropdownMenuTrigger asChild>
                                    <Button variant="ghost" size="icon" className="rounded-full hover:bg-gray-100 dark:hover:bg-slate-800">
                                ...
                                <DropdownMenuContent align="end" className="w-56">
                                    ...
                                    <DropdownMenuSeparator />
                                    <DropdownMenuItem onClick={handleSignOut} className="text-red-500 focus:bg-red-50 dark:focus:bg-red-950/20">
            ...
            <main className="mx-auto max-w-7xl px-4 py-12 sm:px-6 md:py-16">
                                    ...
                                    <div>
                                        ...
                                        <div className="flex flex-wrap gap-4 mt-6">
                                            <div className="flex items-center gap-2">
                                                ...
                                                <span className="text-sm text-gray-600 dark:text-gray-400">10k+ Configs</span>
                                            </div>
                                            <div className="flex items-center gap-2">
                                                <div className="h-2 w-2 rounded-full bg-blue-500"></div>
                                                <span className="text-sm text-gray-600 dark:text-gray-400">3 Environments</span>
                                            </div>
                                            <div className="flex items-center gap-2">
                                                <div className="h-2 w-2 rounded-full bg-purple-500"></div>
                                                <span className="text-sm text-gray-600 dark:text-gray-400">847 Deployments</span>
                                            </div>
                                        </div>
                                    </div>
                ...
                <section className="mb-12">
                    ...
                    <div className="overflow-hidden rounded-2xl bg-white shadow-md dark:bg-slate-900">
                        <div className="divide-y divide-gray-200 dark:divide-gray-800">
                            {[1, 2, 3, 4, 5].map((i) => (
                                <div key={i} className="flex items-center gap-4 p-4 hover:bg-gray-50 dark:hover:bg-slate-800/50">
                                    <div className="flex h-10 w-10 items-center justify-center rounded-full bg-blue-100 dark:bg-blue-900/30">
                                        <GitBranch className="h-5 w-5 text-blue-600 dark:text-blue-400" />
                                    </div>
                                    <div className="flex-1">
                                        <p className="font-medium">Config <span className="font-semibold">api-keys.json</span> was updated</p>
                                        <p className="text-sm text-gray-500 dark:text-gray-400">New environment variable added by Alex Johnson</p>
                                    </div>
                ...
                <section>
                    ...
                    <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
                        {[
                            { name: "API Settings", env: "Production", icon: "Server" },
                            { name: "Database Config", env: "Staging", icon: "Database" },
                            { name: "Auth Keys", env: "Development", icon: "Shield" },
                        ].map((config, i) => (
                            <div
                                key={i}
