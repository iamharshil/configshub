...
function SignupContent() {
	...
	// Reset OAuth loading states after timeout
	useEffect(() => {
		if (isGoogleLoading) {
	...
	const handleGithubSignin = useCallback(async () => {
		...
		try {
			...
			if (error) {
				...
				setError(error.message || "Could not authenticate with GitHub");
				setIsGithubLoading(false);
			}
			// If successful, user will be redirected to GitHub
		} catch (error) {
			console.error("Unexpected error in GitHub sign-in:", error);
			setError("An unexpected error occurred. Please try again.");
			setIsGithubLoading(false);
		}
	}, []);
	...
	return (
		<div className="min-h-screen bg-gradient-modern relative overflow-hidden">
			...
			<div className="absolute inset-0 overflow-hidden pointer-events-none">
				...
				<div className="absolute bottom-32 left-20 w-80 h-80 bg-secondary/8 rounded-full blur-3xl animate-float animation-delay-4000"></div>
			</div>
			...
			<div className="relative z-10 flex items-center justify-center px-6 min-h-screen">
				<div className="w-full max-w-md">
					<div className="text-center mb-8 scale-in">
						<div className="mx-auto w-16 h-16 bg-gradient-primary rounded-2xl flex items-center justify-center mb-6 shadow-modern">
							<Sparkles className="w-8 h-8 text-white" />
						</div>
						<h1 className="text-3xl font-bold mb-2 gradient-text">Join ConfigsHub</h1>
						<p className="text-gray-600 dark:text-gray-400">
							Start managing your configurations like a pro
						</p>
					</div>

					<div className="glass-card p-8 rounded-2xl shadow-modern scale-in">
						{/* <div className="mb-6">
							<Link
								href="/"
							...
							<div className="space-y-2">
								...
								<div className="relative">
									...
									<Input
										...
										className="input-modern pl-10 pr-12 h-12"
										disabled={isLoading}
									/>
									<button
										type="button"
						...
						<Button
							...
							className="btn-primary w-full h-12 mt-6 rounded-xl"
						>
							{isLoading ? (
								<>
						...
						<div className="relative my-6">
							...
							<div className="relative flex justify-center text-xs uppercase">
								<span className="bg-white dark:bg-slate-900 px-3 text-gray-500 font-medium">
									or
								</span>
							</div>
						</div>
						...
						<div className="space-y-4">
							<Button
								...
								variant="outline"
								className="btn-glass w-full h-12 rounded-xl"
