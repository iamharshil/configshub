				...
				<div className="relative mx-auto max-w-5xl text-center">
					...
					<div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
						<Link href="/auth/signup">
							<Button
								size="lg"
								className="text-lg px-8 py-4 h-auto min-w-[200px] bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700"
							>
								Start free trial
			...
			<section id="about" className="py-20 px-6 lg:px-8">
				<div className="max-w-6xl mx-auto">
					<div className="grid lg:grid-cols-2 gap-16 items-center">
						<div>
							<h2 className="text-4xl font-bold mb-6">Stop wrestling with configuration chaos</h2>
			...
			<section className="py-20 px-6 lg:px-8 bg-gray-50 dark:bg-slate-900/50" id="features">
				<div className="max-w-6xl mx-auto">
					<div className="text-center mb-16">
						<h2 className="text-4xl font-bold mb-4">Built for modern startups</h2>
			...
			<section className="py-20 px-6 lg:px-8 bg-gradient-to-br from-blue-900 via-purple-900 to-slate-900 text-white relative overflow-hidden">
				...
				<div className="max-w-4xl mx-auto text-center relative">
					...
					<p className="text-xl text-blue-100 mb-12 max-w-2xl mx-auto">
						Join thousands of developers who trust ConfigsHub to manage their configurations. Start your
						free trial today.
					</p>
					...
					<div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
						<Link href="/auth/signup">
							<Button
								size="lg"
								className="text-lg px-8 py-4 h-auto min-w-[200px] bg-white text-gray-900 hover:bg-gray-100"
							>
								Start free trial
								<ArrowRight className="ml-2 h-5 w-5" />
							</Button>
						...
						<Button
							variant="outline"
							size="lg"
							className="text-lg px-8 py-4 h-auto min-w-[200px] border-white/30 text-white hover:bg-white/10"
						>
							<Play className="mr-2 h-5 w-5" />
							Watch demo
						</Button>
