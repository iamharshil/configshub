...
interface PageLayoutProps {
    ...
    search?: React.ReactNode; // Slot for search bar
    className?: string; // For content area overrides if absolutely necessary
}
...
export function PageLayout({
    ...
    return (
        <div className="flex flex-col h-full bg-background md:bg-transparent min-h-0">
            {/* Header */}
            <div className="flex-none flex items-center justify-between p-4 md:p-8 border-b border-border/50 bg-background/50 backdrop-blur-sm sticky top-0 z-10 transition-all duration-200">
